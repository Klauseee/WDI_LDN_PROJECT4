        ...
        <div key={i}>
          <div className="control has-icons-left">
            <div className="cta-caddy">
              ...
              <p className="button warning cta" onClick={() => removeRepeaterInput(property, array, i)}>Remove</p>
            </div>
          </div>
        </div>
      )}
      <div className="cta-caddy">
        <p className="button info cta" onClick={() => addRepeaterInput(property, array)}>{`Add ${property}`}</p>
      </div>
    </div>
  );
};
